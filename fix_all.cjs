...
const backendContent = `import { describe, it, expect, vi, beforeEach } from 'vitest';
...
`;
fs.writeFileSync('tests/backend/settings.integration.test.ts', backendContent);

let frontend = fs.readFileSync('tests/frontend/SettingsView.test.tsx', 'utf8');
frontend = "/**\n * @vitest-environment jsdom\n */\n" + frontend;
frontend = frontend.replace("import '@testing-library/jest-dom';", "import '@testing-library/jest-dom';");
